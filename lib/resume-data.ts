...
export const resumeProjects: ProjectItem[] = [
  {
    title: 'Markdown Video Generator',
    techStack: '(NextJS, Framer Motion, FFMPEG, HTML-2-Canvas-Pro)',
    points: [
      ...
      '• Engineered a scene rendering + capture pipeline supporting complex primitives (code diffs, terminal playback, animated charts, particles, zoom/pan/shake camera effects) and exported final videos via FFmpeg.wasm.',
      '• Shipped a production-grade editor with live preview, project persistence, templates, keyboard shortcuts, theming, and one-click video export; featured as Peerlist Staff Pick (Week 51, 2025) with 200+ community upvotes, ranked #1.',
    ],
  },
  {
    title: 'ARCHFLOW',
    ...
    points: [
      ...
      '• Engineered real-time collaborative editing with shared cursors, presence, and deterministic state synchronization using Liveblocks and Zustand, alongside export/import (PNG, SVG, JSON) for versioning and handoff.',
