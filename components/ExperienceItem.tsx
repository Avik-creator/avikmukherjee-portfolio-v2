        ...
        >
          ...
          <h3 className="grow font-medium text-gray-800 dark:text-neutral-200 underline decoration-gray-400 dark:decoration-neutral-400/50 underline-offset-[3px] transition-colors">
            ...
            >
              ...
              <ArrowUpRight
                size={12}
                className="opacity-0 translate-y-px transition-all duration-150 group-hover:opacity-60 group-hover:translate-y-0"
              />
            </Link>
          </h3>

          <span className="text-gray-600 dark:text-neutral-500 text-sm shrink-0">
            {year}
          </span>
        </div>
      </div>
