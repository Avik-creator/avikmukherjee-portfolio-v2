...
export default function BlogListClient({ groupedPosts, sortedYears }: Props) {
  ...
  return (
    <div className="m-auto flex flex-col gap-8 relative">
      {/* ── Filters ────────────────────────────────────────────────────── */}
      <div className="flex flex-row gap-3 items-center animate-[slideFadeUp_0.25s_ease-out] relative z-10 overflow-visible" style={{ animationDelay: '0.05s', animationFillMode: 'both' }}>
        {/* Search Input */}
