...
A compact component that displays GitHub repository star count with a tooltip showing the full number. Perfect for showcasing project popularity and engagement.
    ...
    <Tooltip>
      <TooltipTrigger asChild>
        <Button className="gap-1.5 pr-1.5 pl-2" variant="ghost" asChild>
          ...
          >
            <svg className="-translate-y-px" viewBox="0 0 24 24" width="16" height="16">
              <path
            ...
            <span className="text-[13px] text-gray-500 dark:text-neutral-500 tabular-nums">
