...
seoTitle: "Reed-Solomon Erasure Coding: How S3 Actually Works"
...
But the last time I really dug into how S3 achieves _1 petabyte per second_ of throughput on top of HDDs that haven't gotten faster in 30 years, I kept hitting this term: erasure coding. Specifically, Reed-Solomon erasure coding.

This whole blog post idea came after watching [Mehul Mohan's excellent video](https://www.youtube.com/watch?v=GgZV67IQ5hA) and reading [Stanislav Kozlovski's insightful article on how S3 scales with millions of hard drives](https://bigdata.2minutestreaming.com/p/how-aws-s3-scales-with-tens-of-millions-of-hard-drives). I saw the video but generally don't like to comment, so instead I decided to build something. What you're reading is my implementation of erasure coding learned from that video, with some help from AI. [Here's my implementation on my blog](https://avikmukherjee.me/blog/reed-solomon-erasure-coding). Props to Mehul and Stanislav for making this click.
...
If you want to build the Go implementation yourself, the full code is [on GitHub](https://github.com/Avik-creator/erasure-coding). No external dependencies. ~400 lines. Runs with `go run main.go`.
...
Do [Share this](https://x.com/intent/tweet?text=Check%20out%20my%20new%20post%20on%20Reed-Solomon%20erasure%20coding%20%E2%80%94%20how%20it%20works%20and%20why%20it%20matters.%20https%3A%2F%2Favikmukherjee.me%2Fblog%2Freed-solomon-erasure-coding), or reach out on [GitHub](https://github.com/Avik-creator). I'm always curious about what problems people are trying to solve — and honestly, writing about it is how I figure things out too.
...
_If you want to talk distributed systems, storage engineering, or just what it's like to build your way to understanding — find me on [GitHub](https://github.com/Avik-creator), [X](https://x.com/avikm744), [Peerlist](https://peerlist.io/avikmukherjee), or [LinkedIn](https://www.linkedin.com/in/avik-mukherjee-8ab9911bb)._
